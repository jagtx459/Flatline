...
Use the "Report a vulnerability" button under this repository's Security tab. Private vulnerability reporting is enabled, so the report stays between us until a fix is ready.
